...
public class NotSimpleVersionedPersisterServiceTest {
    ...
    public void testUpdate() {
        ...
        VersionMapping versionMapping = new VersionMapping(1, "TEST", null, firstVersion.getVersion(),  "test_table", "","id", "deleted_ts", null, -1, 1, SyncTypeEnum.NOT_VERSIONED);
        List<FieldMapping> fieldMappings = createFieldMappings();
    ...
    public void testInsert() {
        ...
        VersionMapping versionMapping = new VersionMapping(1, "TEST", null, oldVersion.getVersion(),  "test_table", "","id", "deleted_ts", null, -1, 1, SyncTypeEnum.NOT_VERSIONED);
        List<FieldMapping> fieldMappings = createFieldMappings();
    ...
    public void testRepeatVersion() {
        ...
        VersionMapping versionMapping = new VersionMapping(null, firstRdmVersion.getCode(), null,  firstRdmVersion.getVersion(), testTable, "","id", "deleted_ts", LocalDateTime.now(), 2, null, SyncTypeEnum.NOT_VERSIONED);
        SyncSourceService syncSourceService = mock(SyncSourceService.class);
