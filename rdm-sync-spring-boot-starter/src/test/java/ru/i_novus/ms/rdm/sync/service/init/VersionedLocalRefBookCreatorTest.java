...
public class VersionedLocalRefBookCreatorTest {
    ...
    public void testCreate() {
        ...
        creator.create(testCode, null, source, SyncTypeEnum.SIMPLE_VERSIONED, null);
    ...
    private VersionMapping createVersionMapping(String testCode) {
        return new VersionMapping(null, testCode, null, "CURRENT", "rdm.ref_test", "someSource", "id", null, null, -1, null, SyncTypeEnum.SIMPLE_VERSIONED);
    }
